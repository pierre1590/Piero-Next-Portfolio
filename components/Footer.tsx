    ...
    <footer className="bg-gray-100 text-gray-700 py-10">
      <div className="container mx-auto px-4 flex flex-col items-center">
        ...
        <div className="flex space-x-6 mb-4">
          ...
          <Link href="https://github.com/pierre1590" passHref legacyBehavior>
            <a className="text-gray-500 hover:text-gray-800 transition-colors duration-300">
              <FaGithub size={24} />
            </a>
          </Link>
        </div>
        ...
        <div className="flex space-x-4 text-sm text-gray-500 mb-2">
          ...
          <a href="https://www.iubenda.com/privacy-policy/60158333/cookie-policy" className="iubenda-white iubenda-noiframe iubenda-embed iubenda-noiframe" title="Cookie Policy">
            Cookie Policy
          </a>
        </div>
